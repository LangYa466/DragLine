 ...
 */
package dragline.file;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import dragline.file.configs.*;
...
public class FileManager extends MinecraftInstance {
    ...
    public final File dir = new File(mc.getDataDir(), DragLine.INSTANCE.getCLIENT_NAME() + "-" + Backend.MINECRAFT_VERSION_MAJOR + "." + Backend.MINECRAFT_VERSION_MINOR);
    public final File settingsDir = new File(dir, "settings");
    public final File soundsDir = new File(dir, "sounds");
    public final File cnfontsDir = new File(dir, "cnfonts");
    public final File cloudDir = new File(dir, "cloud");
    public final File datouDir = new File(cloudDir, "datou");
    ...
    private void saveConfig(final FileConfig config, final boolean ignoreStarting) {
        if (!ignoreStarting && DragLine.INSTANCE.isStarting())
            return;
    ...
    public void loadBackground() {
        if(backgroundFile.exists()) {
            try {
                ...
                DragLine.INSTANCE.setBackground(classProvider.createResourceLocation("liquidbounce/background.png"));
                mc.getTextureManager().loadTexture(DragLine.INSTANCE.getBackground(), classProvider.createDynamicTexture(bufferedImage));
