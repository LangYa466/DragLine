...
import dragline.features.module.modules.misc.Spammer
...
object SettingsUtils {
            ...
            when (args[0]) {
                ...
                "load" -> {
                    ...
                    val url = if (urlRaw.startsWith("http"))
                        ...
                        "${DragLine.CLIENT_CLOUD}/settings/${urlRaw.toLowerCase()}"
                ...
                "targetDead" -> {
                    ...
                    val value = args[2]
                    val module = DragLine.moduleManager.getModule(moduleName)
    ...
    fun generateScript(values: Boolean, binds: Boolean, states: Boolean): String {
        ...
        DragLine.moduleManager.modules.filter {
