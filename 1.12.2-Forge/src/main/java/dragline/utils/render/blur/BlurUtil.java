...
public class BlurUtil {
    ...
    private static final ResourceLocation blurShader = new ResourceLocation("paradise/blurarea.json");
...
//        setValues(blurStrength);
        ...
        bufferrender.pos(0.0D, f1, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        bufferrender.pos(f, f1, 0.0D).tex(f2, 0.0D).color(255, 255, 255, 255).endVertex();
        bufferrender.pos(f, 0.0D, 0.0D).tex(f2, f3).color(255, 255, 255, 255).endVertex();
        bufferrender.pos(0.0D, 0.0D, 0.0D).tex(0.0D, f3).color(255, 255, 255, 255).endVertex();
        tessellator.draw();
