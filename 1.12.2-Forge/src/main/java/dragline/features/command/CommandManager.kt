...
import dragline.features.command.commands.*
import dragline.features.command.shortcuts.Shortcut
import dragline.features.command.shortcuts.ShortcutParser
...
class CommandManager {
    ...
    fun registerShortcut(name: String, script: String) {
        if (getCommand(name) == null) {
            ...
            DragLine.fileManager.saveConfig(DragLine.fileManager.shortcutsConfig)
        } else {
