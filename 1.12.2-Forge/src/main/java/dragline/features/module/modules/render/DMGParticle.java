...
import dragline.utils.render.DMGPUtil.Location;
import dragline.utils.render.DMGPUtil.Particles;
...
public class DMGParticle extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        KillAura ka = (KillAura) moduleManager.getModule(KillAura.class);
        ...
        final Criticals criticals = (Criticals) moduleManager.get(Criticals.class);
