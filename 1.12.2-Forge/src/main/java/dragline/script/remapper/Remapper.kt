...
package dragline.script.remapper
...
object Remapper {
    ...
    private val srgFile = File(DragLine.fileManager.dir, "mcp-$srgName.srg")
    ...
    fun loadSrg() {
        ...
        if (!srgFile.exists()) {
            ...
            HttpUtils.download("${DragLine.CLIENT_CLOUD}/srgs/mcp-$srgName.srg", srgFile)
