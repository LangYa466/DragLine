...
import me.liying.utils.render.GLUtils;
import me.rainyfall.utils.ColorUtils;
...
//            s = EnumChatFormatting.getTextWithoutFormattingCodes(s);
    ...
    public int drawString(String s, float x, float y, int color,boolean shadow, int size){
        return this.drawString(s, x, y, color, shadow,size);
    }
