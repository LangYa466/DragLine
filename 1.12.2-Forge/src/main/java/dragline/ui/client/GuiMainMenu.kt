...
class GuiMainMenu : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.fontBold180.drawCenteredString(DragLine.CLIENT_NAME, representedScreen.width / 2F, representedScreen.height / 8F, Color.WHITE.rgb, true)
        Fonts.font35.drawCenteredString("b" + DragLine.CLIENT_VERSION, representedScreen.width / 2F + 148, representedScreen.height / 8F + Fonts.font35.fontHeight, 0xffffff, true)
