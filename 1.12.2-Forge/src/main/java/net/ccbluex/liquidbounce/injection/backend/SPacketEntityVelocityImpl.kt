...
import dragline.api.minecraft.network.play.server.ISPacketEntityVelocity
import net.minecraft.network.play.server.SPacketEntityVelocity

class SPacketEntityVelocityImpl<T : SPacketEntityVelocity>(wrapped: T) : PacketImpl<T>(wrapped),
    ISPacketEntityVelocity {
