...
import dragline.api.minecraft.client.render.ITessellator
import dragline.api.minecraft.client.render.IThreadDownloadImageData
import dragline.api.minecraft.client.render.WIImageBuffer
import dragline.api.minecraft.client.render.texture.IDynamicTexture
import dragline.api.minecraft.client.render.vertex.IVertexFormat
import dragline.api.minecraft.client.renderer.IGlStateManager
import dragline.api.minecraft.client.renderer.vertex.IVertexBuffer
...
import dragline.api.minecraft.nbt.*
    ...
    override fun getPotionEnum(type: PotionType): IPotion {
        return PotionImpl(
            when (type) {
                ...
                PotionType.DIG_SPEED -> MobEffects.HASTE
                PotionType.STRENGTH -> MobEffects.STRENGTH
            }
        )
    }
