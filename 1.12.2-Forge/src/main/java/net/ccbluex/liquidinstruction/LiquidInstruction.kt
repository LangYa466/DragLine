...
fun main() {
    ...
    val label = JLabel(
        dragline.DragLine::class.java.getResourceAsStream("/instructions.html").reader().readText()
            .replace("{assets}", DragLine.javaClass.classLoader.getResource("assets").toString()))
