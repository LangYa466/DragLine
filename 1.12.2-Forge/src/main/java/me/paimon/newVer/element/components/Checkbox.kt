...
import java.awt.Color
    ...
    fun onDraw(x: Float, y: Float, width: Float, height: Float, bgColor: Color, accentColor: Color) {
        ...
        RenderUtils.drawRoundedRect2(x - 0.5F, y - 0.5F, x + width + 0.5F, y + width + 0.5F, 3F, borderColor.rgb)
        RenderUtils.drawRoundedRect2(x, y, x + width, y + width, 3F, mainColor.rgb)
