...
public class ValueButton {
    ...
    public void render(int mouseX, int mouseY, Window parent) {
        final IFontRenderer font = Fonts.font35;
        ...
        if (value instanceof BoolValue) {
            ...
            if (mouseX > x - 9 && mouseX < x + 87 && mouseY > y - 4 && mouseY < y + font.getFontHeight() + 4 && Mouse.isButtonDown(0)) {
            ...
            RenderUtils.drawRect(x + 1, y - 6, (x + 87.0f + parent.allX), y + font.getFontHeight() + 6, new Color(29, 29, 29).getRGB());
            RenderUtils.drawRect((float) (x + 1), y - 6, (float) (x + number + 1.0 + parent.allX), y + font.getFontHeight() + 6, valuebackcolor);
        ...
        if (!(value instanceof IntegerValue)) {
            font.drawStringWithShadow(value.getName(), x - 7 + 2, (int) y, -1);
        }
        if (value instanceof BoolValue) {
            font.drawStringWithShadow(name, x + font.getStringWidth(value.getName()) + 2, (int) y, -1);
        }
        if (value instanceof IntegerValue) {
            font.drawStringWithShadow(value.getName(), x - 7, (int) (y - 1), -1);
            font.drawStringWithShadow(name, x + font.getStringWidth(value.getName()) + 2, (int) (y - 1), -1);
        }
        if (value instanceof ListValue) {
            font.drawStringWithShadow(name, x + 90 - font.getStringWidth(name) + 2, (int) y, -1);
        }
    }
    ...
    public void click(int mouseX, int mouseY, int button) {
        if (!custom && mouseX > x - 9 && mouseX < x + 87 && mouseY > y - 4 && mouseY < y +Fonts.font35.getFontHeight() + 4) {
            if (value instanceof BoolValue) {
