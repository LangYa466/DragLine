...
import me.nelly.utils.blur.GLUtil;
import me.nelly.utils.blur.ShaderUtil;
...
public class RoundedUtil {
    ...
    public static void drawRound(float x, float y, float width, float height,  Color color) {
        drawRound(x, y, width, height, 0f, false, color);
    }
