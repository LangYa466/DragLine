package sk1d.unknow.ui.newdropdown.utils.objects;

import com.google.common.base.Predicate;
import me.liying.utils.render.LiYingUtil;
import me.liying.fonts.api.FontRenderer;
...
public class PasswordField extends Gui {
    ...
    public void setCursorPosition(int p_146190_1_) {
        ...
        this.cursorPosition = LiYingUtil.clamp_int(this.cursorPosition, 0, i);
    ...
    public void setSelectionPos(int p_146199_1_) {
        ...
        if (fontRenderer != null) {
            ...
            this.lineScrollOffset = LiYingUtil.clamp_int(this.lineScrollOffset, 0, i);
        }
    }
