package sk1d.unknow.ui.newdropdown.utils.render;

import dragline.DragLine;
import dragline.api.enums.WDefaultVertexFormats;
import dragline.api.minecraft.client.render.ITessellator;
import dragline.api.minecraft.client.render.IWorldRenderer;
import dragline.api.minecraft.util.IScaledResolution;
import sk1d.unknow.ui.newdropdown.utils.animations.Animation;
import sk1d.unknow.ui.newdropdown.utils.normal.Utils;
...
import static dragline.utils.MinecraftInstance.mc2;
...
public class DrRenderUtils implements Utils {
    ...
    public static void drawModalRectWithCustomSizedTexture(float x, float y, float u, float v, float width, float height, float textureWidth, float textureHeight) {
        ...
        IWorldRenderer worldrenderer = DragLine.INSTANCE.getWrapper().getClassProvider().getTessellatorInstance().getWorldRenderer();
    ...
    public static void drawGradientRectSideways(double left, double top, double right, double bottom, int startColor, int endColor) {
        ...
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        GlStateManager.shadeModel(7425);
        ITessellator tessellator = DragLine.INSTANCE.getWrapper().getClassProvider().getTessellatorInstance();
