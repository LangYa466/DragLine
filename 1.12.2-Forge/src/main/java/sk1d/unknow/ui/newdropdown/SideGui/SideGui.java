package sk1d.unknow.ui.newdropdown.SideGui;
...
import sk1d.unknow.ui.newdropdown.utils.normal.TimerUtil;
import sk1d.unknow.ui.newdropdown.utils.objects.Drag;
      ...
      //  }
       ...
       // }
        ...
        if (!clickAnimation.isDone()) {
            drag.setX(LiYingUtil.interpolateFloat(sr.getScaledWidth() - 30, focused ? sr.getScaledWidth() / 2f - rectWidth / 2f : drag.getX(), (float) clickAnimation.getOutput()));
            drag.setY(LiYingUtil.interpolateFloat(sr.getScaledHeight() / 2f - rectHeight / 2f, drag.getY(), (float) clickAnimation.getOutput()));
        }
        ...
        RenderUtils.drawRound(x, y, rectWidth, rectHeight, 9, mainRectColor);
        if (!focused) return;
        ...
        for (String category : categories) {
            ...
            final ClickGUI hud = (ClickGUI) DragLine.moduleManager.getModule(ClickGUI.class);
            Color color22 = ClickGUI.generateColor();
            ...
            RenderUtils.drawRound(xVal - 30, yVal - 5, 60, Fonts.SFBOLD.SFBOLD_26.SFBOLD_26.getHeight() + 10, 6, finalColor);
