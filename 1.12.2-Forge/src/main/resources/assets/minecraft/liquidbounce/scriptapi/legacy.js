...
var _AdaptedModule = function (module) {
    ...
    this.moduleManager = Java.type("dragline.LiquidBounce").moduleManager;
...
var _ModuleManager = function () {
    ...
    this.moduleManager = Java.type("dragline.LiquidBounce").moduleManager;
    this.Module = Java.type("dragline.features.module.Module");
...
var _CommandManager = function () {
    ...
    this.Command = Java.type("dragline.features.command.Command");
    this.commandManager = Java.type("dragline.LiquidBounce").commandManager;
